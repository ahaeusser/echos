...
* `m4_monthly_subset`: Six monthly time series drawn from the well‑known M4 Forecasting Competition.
...
The dataset `m4_monthly_subset` is a `tsibble` with six monthly time series from the M4 Forecasting Competition. The dataset contains the following time series:
